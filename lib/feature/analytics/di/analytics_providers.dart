...
import 'package:poozizic/feature/analytics/data/repository/analytics_repository_impl.dart';
...
final getWeeklyFrequencyUseCaseProvider = Provider<GetWeeklyFrequencyUseCase>((
  ref,
) {
  final repository = ref.watch(analyticsRepositoryProvider);
...
final analyticsNotifierProvider =
    StateNotifierProvider<AnalyticsNotifier, AnalyticsState>((ref) {
      final getAnalyticsSummaryUseCase = ref.watch(
        getAnalyticsSummaryUseCaseProvider,
      );
      final getBowelDistributionUseCase = ref.watch(
        getBowelDistributionUseCaseProvider,
      );
      final getWeeklyFrequencyUseCase = ref.watch(
        getWeeklyFrequencyUseCaseProvider,
      );
